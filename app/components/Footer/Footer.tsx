            ...
            <div className="mx-auto max-w-2xl pt-48 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="my-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4 md:col-span-12 lg:col-span-4'>
                        <img src={'/assets/logo/logo.svg'} alt="logo" style={{height: '110px'}} className='pb-8' />
                    ...
                    <div className='col-span-4 md:col-span-4 lg:col-span-4'>
                        ...
                        <div className="flex gap-2 mt-10">
                            ...
                            <h5 className="text-base font-normal text-offwhite">+ 12 34 56 78 90</h5>
                        </div>
                        <div className="flex gap-2 mt-10">
                ...
                <div className='py-10 lg:flex items-center justify-between border-t border-t-bordertop'>
                    <h4 className='text-offwhite text-sm text-center lg:text-start font-normal'>©2024 All Rights Reserved by <Link href="https://www.aramco.com/en" target="_blank"> Aramco.com</Link></h4>
