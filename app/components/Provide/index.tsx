                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 gap-8'>
                    ...
                    <div className='col-span-6 flex justify-center'>
                        <div className="flex flex-col align-middle justify-center p-10">
                            <p className="text-4xl lg:text-6xl pt-4 font-semibold lh-81 mt-5 text-center lg:text-start">Powerful data visualization tools for deep dives</p>
                            <h4 className="text-lg pt-4 font-normal lh-33 text-center lg:text-start text-bluegray">Loreum Ipsum inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo</h4>
                            <Link href={'/'} className="mt-4 text-xl font-medium text-blue flex gap-2 mx-auto lg:mx-0 space-links"> </Link>
                        ...
                        {/* <div className='grid grid-cols-1 sm:grid-cols-2 gap-x-16 gap-y-10 lg:gap-x-40 px-10 py-12 bg-bluebg rounded-3xl'> */}
                            {/* {Aboutdata.map((item, i) => (
                                <div key={i} className='bg-white rounded-3xl lg:-ml-32 p-6 shadow-xl'>
                                    ...
                                    <Image src={'/assets/provide/why-mockup-right.png'} alt={'mockup-right'} width={64*7} height={64*7} />
                        {/* </div> */}
                    </div>
